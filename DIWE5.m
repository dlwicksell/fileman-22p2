DIWE5 ;SFISC/GFT-WP, AUX FUNCTIONS ;09:20 AM  28 Oct 1999
...
F ;
 ...
 Q
X ;FILE TRANSFER
 I '$D(^%ZOSF("EON"))!'$D(^("EOFF")) W !,$$EZBLD^DIALOG(810),!! Q
 D  Q:X=""  S DIWL=X,(%,%B)="" X ^%ZOSF("EOFF")
...
A R X#245:30 E  I '$L(X) D S:$L(%B) X ^%ZOSF("EON") W !!,$$EZBLD^DIALOG(8157),! Q
