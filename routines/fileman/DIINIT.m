DIINIT	; ; 08-MAR-2013 ; 3/8/13 10:41am
	...
	S DIOVRD=1,U="^",DIFQ=0,DIFROM="22.2V2" W !,"This version (#22.2V2) of 'DIINIT' was created on 08-MAR-2013"
...
EN	; ENTER HERE TO BYPASS THE PRE-INIT PROGRAM
	...
	S DIFROM="22.2V2" D PKG:'$D(DIFROM(0)),^DIINIT1 G Q:'$D(DIFQ) S DIK(0)="AB"
