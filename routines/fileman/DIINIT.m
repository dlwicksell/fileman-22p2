DIINIT	; ; 13-DEC-2012
	...
	S DIOVRD=1,U="^",DIFQ=0,DIFROM="22.2T0" W !,"This version (#22.2T0) of 'DIINIT' was created on 13-DEC-2012"
...
EN	; ENTER HERE TO BYPASS THE PRE-INIT PROGRAM
	...
	S DIFROM="22.2T0" D PKG:'$D(DIFROM(0)),^DIINIT1 G Q:'$D(DIFQ) S DIK(0)="AB"
