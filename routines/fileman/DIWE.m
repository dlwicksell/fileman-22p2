DIWE	;SFISC/GFT,XAK-START OF WP ;2013-01-15  12:50 PM
...
W	W !?DL+DL-2
	S Z=+$P($G(DC),U,2),Z=$S(Z:$P($G(^DD(Z,.01,0)),U,2),1:"") I Z["I",DWLC D ^DIALOG(3090,DH) W ! S I=DWLC,J=1 D LL^DIWE1 G Q ;UNEDITABLE W-P
